...
public class ak47 : MonoBehaviour
{
    ...
    // mouse 1 ve mouse 0 a týklandýðýnda çalýþacak
    void atesEt(bool yakinlasmaVarmi)
    {
        ...
        if (Physics.Raycast(benimCam.transform.position, benimCam.transform.forward, out hit, menzil))
        {
            ...
            else if (hit.transform.gameObject.CompareTag("devrilebilirObje"))
            {
                ...
                // objeye ileri doðru kuvvet uygulama
    ...
    // herhangi bir silahta ateþ edip, reload yaptýktan sonra, oyunu kapatýp yeniden açarsan,
    // ateþ ettiðin yani reload yaptýðýn miktar kadar toplam merminden mermi düþüyor.!!!
